            ...
            <div className='page-content'>
                                ...
                                <div className="row">
                                    ...
                                    <div className='row'>
                                        <div className='col-lg-3 mobile-only' style={{ 'textAlign': 'center' }}>
                                            <img src='figx-logo-2.png' id="welcome-logo-left" ></img>
                                        ...
                                        <div className='col-lg-3 desktop-only' style={{ 'textAlign': 'center' }}>

                                            <img src='figx-logo-2.png' id="welcome-logo-right" ></img>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        {/* <div> */}
                        <h2>About FIGX</h2>
                        <div id='topic-frontpage' className='col-lg-10' style={{ 'paddingTop': '10px' }}>
                            FIGX is an acronym for the <b className='verybold'>Future Intelligent Graphical eXperience</b>. It can be thought of as <b className='verybold'>Fig. X</b>, the graphic representation that springs to mind when you are drafting an article. We chose this name to reflect our lab's commitment to pushing the boundaries of innovation and exploration in graphical experiences.
